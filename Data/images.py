...
notinlist = os.listdir("Images/img/")
...
for i in tqdm.tqdm(range(0, 257402, 2)):
    ...
    if f"{format(i//2, '06')}_0.png" not in notinlist:
        try:
            ...
            open(f"Images/img/{format(i//2, '06')}_0.png", "wb").write(response.content)
        except:
            pass
...
#            failed.flush()
    ...
    if f"{format(i//2, '06')}_1.png" not in notinlist:
        try:
            ...
            open(f"Images/img/{format(i//2, '06')}_1.png", "wb").write(response2.content)
        except:
            pass
